...
def room_page(room_id):
    ...
    if room.get("image_coords"):
        ...
        box_width = floor(height_ratio * room['image_coords'][2]) - floor(height_ratio * room['image_coords'][0])
	box_height = floor(height_ratio * room['image_coords'][3]) - floor(height_ratio * room['image_coords'][1])
